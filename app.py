...
def update_data(n, val):  # inpur parameter(s)
    if n == None:
        return "Hey there! Please enter a legitimate stock code to get details.", "https://images.clickastro.com/ca/mvcimages/ogimages/indian-stock-market-predictions.jpg", "Stocks",None, None, None
        # raise PreventUpdate
    else:
        if val == None:
            raise PreventUpdate
